				...
				if(result=='OK'){
					...
					for(var i=0;i<jsonArray.length;++i){
						...
						$("#gallery-wrapper").append("<article class='white-panel' id='"+oneline.image_id+"' data-index='"+i+"'><img src='"+
							...
							"</div><div id='img_o"+i+"' style='display: none'>"+oneline.image_name+"</div><div><div class='checkbox checkbox-danger'><input type='checkbox' id='_"+oneline.image_id+"' class='styled'><label for='_"+oneline.image_id+"'>"+oneline.image_name+"</label></div></div></article>");
					}
