        ...
        function(data, status) {
            ...
            for (i = 0; i < jsonArray.length; i += 3) {
                ...
                for (j = 0; j < 3&&i+j<jsonArray.length; j++) {
                    pig_row += '<div class="col-xs-4"><img style="width:100px;height: 100px" class="img-square" src="' + jsonArray[i + j].img_s + '"/></div>';
                }
                pig_row += "</div>";
    ...
    $.post("/getVideoListByFilter.action", {
        ...
        function(data, status) {
            ...
            for (i = 0; i < jsonArray.length; i += 3) {
                v_row = '<div class = "row">';
                for (j = 0; j < 3&&i+j<jsonArray.length; j++) {
                    v_row += '<div class="col-xs-4"><img style="width:100px;height: 100px" class="img-square" src="' + jsonArray[i + j].cover_img + '"/></div>';
                }
                v_row += "</div>";
