					...
					<div class="tab-pane fade in active" id="home">
						<div class="panel panel-default">
							<div class="panel-heading">
								<button class="btn btn-primary" data-toggle="modal" onclick="showAddModal()">增加病例</button>
							</div>
							<div class="panel-body">
								...
								<ul class="pagination" id="paginator" style="float: right;"></ul>
							</div>
						</div>
					</div>
